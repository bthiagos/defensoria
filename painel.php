      		...
      		<div class="panel-heading">
				Atendimento Inicial
      			...
      			<div class="panel-body">
					Seja bem-vindo, <?php echo $_SESSION['nome'];?><hr><br/>
					<div class="row">
						<div class="col-sm-3"></div>
						<div class="col-sm-3">
							<a class="btn btn-success btn-lg btn-block" href="novoAtendimento.php">
								<i class="fa fa-plus-circle"></i> Novo Atendimento</a>
						</div>
						<div class="col-sm-3">
							<a class="btn btn-info btn-lg btn-block" href="consultarAtendimento.php" method="GET">
