                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="verFuncionario-admin.php?id=<?php echo $dados['MAT_FUNC']; ?>"
                                                class="btn btn-success btn-custom">
                                                <i class="material-icons">visibility</i>
                                            </a>

                                            <a href="editarFuncionario-admin.php?id=<?php echo $dados['MAT_FUNC']; ?>"
                                                class="btn btn-primary btn-custom">
                                                <i class="material-icons">edit</i>
                                            </a>

                                            <a href="excluirFuncionario-admin.php?id=<?php echo $dados['MAT_FUNC']; ?>"
