            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <a href="novoAtendimento-admin.php" class="btn btn-success btn-block"><i class="fa fa-plus "
                        ...
                        <div class="col-sm-12">
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    ORDER BY atendimento.HORA_ATENDIMENTO DESC";
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $dados['PRIORIDADE_ATENDIMENTO']; ?></td>
                                        <td>
                                            <a href="verAtendimento-admin.php?id=<?php echo $dados['ID_ATENDIMENTO']; ?>"
