        ...
        <div class="container">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    Seja bem-vindo, <b><?php echo $_SESSION['nome_func'];?>!</b> Você possui permissões de <b>Administrador</b>
                    <hr><br />
                    <div class="row">
                        <div class="col-sm-3"></div>
                        <div class="col-sm-3">
                            <a class="btn btn-success btn-lg btn-block" href="novoAtendimento-admin.php">
                                <i class="fa fa-plus-circle"></i> Novo Atendimento</a>
                        </div>
                        <div class="col-sm-3">
                            <a class="btn btn-info btn-lg btn-block" href="consultarAtendimento-admin.php" method="GET">
